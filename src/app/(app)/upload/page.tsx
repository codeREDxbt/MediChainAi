...
export default function UploadPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen pb-24">
      ...
      <main className="flex-1 px-4 py-6 space-y-6">
        ...
        <Card className="overflow-hidden">
          <CardContent className="p-6">
            <div className="border-2 border-dashed border-border rounded-3xl p-10 flex flex-col items-center justify-center min-h-[220px] hover:border-primary/50 hover:bg-primary/5 transition-all cursor-pointer group">
        ...
        {/* 3-Step Indicator: Local → Encrypt → IPFS */}
        <Card>
      ...
      {/* Sticky Bottom CTA */}
      <div className="fixed bottom-0 left-0 right-0 p-4 bg-background/90 backdrop-blur-xl border-t border-border max-w-md mx-auto safe-bottom">
